...
void Object::InitWVP() {
	...
	m_Rotation = Rz.SetRotationZ(rotation.z * float(pi*cornerZ / 180.0f)) * Rx.SetRotationX(rotation.x * float(pi*cornerX / 180.0f)) * Ry.SetRotationY(rotation.y * float(pi*cornerY / 180.0f));
